...
must_haves:
  ...
  artifacts:
    - path: "src/HueWindows.Core/Models/ColorGamut.cs"
...
<task type="auto">
  ...
  <files>src/HueWindows.Core/Models/ColorGamut.cs</files>
  <action>
Create new file `src/HueWindows.Core/Models/ColorGamut.cs` with:
...
Ensure the file compiles with `dotnet build src/HueWindows.Core/HueWindows.Core.csproj`.
  </action>
  <verify>
`dotnet build src/HueWindows.Core/HueWindows.Core.csproj` succeeds.
File exists at `src/HueWindows.Core/Models/ColorGamut.cs`.
  </verify>
...
Build Core project:
```
dotnet build src/HueWindows.Core/HueWindows.Core.csproj
```

Verify class structure:
```
grep -E "(public|private|static)" src/HueWindows.Core/Models/ColorGamut.cs | head -20
```
