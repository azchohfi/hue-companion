...
must_haves:
  ...
  artifacts:
    - path: "src/HueWindows/Controls/GamutColorPicker.xaml"
      provides: "XAML structure for custom color picker"
      contains: "CanvasControl"
    - path: "src/HueWindows/Controls/GamutColorPicker.xaml.cs"
...
<task type="auto">
  ...
  <files>src/HueWindows/Controls/GamutColorPicker.xaml</files>
  <action>
Create new UserControl `src/HueWindows/Controls/GamutColorPicker.xaml`:

```xml
<?xml version="1.0" encoding="utf-8"?>
<UserControl
    x:Class="HueWindows.Controls.GamutColorPicker"
...
- Pointer events for drag interaction
  ...
  <verify>
File exists at `src/HueWindows/Controls/GamutColorPicker.xaml`.
  </verify>
...
<task type="auto">
  ...
  <files>src/HueWindows/Controls/GamutColorPicker.xaml.cs</files>
  <action>
Create `src/HueWindows/Controls/GamutColorPicker.xaml.cs`:
...
```
wc -l src/HueWindows/Controls/GamutColorPicker.xaml.cs
```
Should be ~250+ lines.

Check key patterns:
```
grep -E "ColorGamut|HueColor|CanvasControl" src/HueWindows/Controls/GamutColorPicker.xaml.cs
```
