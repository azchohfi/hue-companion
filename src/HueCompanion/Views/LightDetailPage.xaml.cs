...
public sealed partial class LightDetailPage : Page
{
    ...
    private void InitializePowerOnControls()
    {
        ...
        {
            HueCompanion.Core.Models.PowerOnPreset.LastOnState => 0,
            HueCompanion.Core.Models.PowerOnPreset.Safety => 1,
            HueCompanion.Core.Models.PowerOnPreset.PowerFail => 2,
            HueCompanion.Core.Models.PowerOnPreset.Custom => 3,
            _ => 0
        };

        PowerOnPresetRadio.SelectedIndex = index;
        CustomPowerOnPanel.Visibility = ViewModel.PowerOnPreset == HueCompanion.Core.Models.PowerOnPreset.Custom
            ? Visibility.Visible
            : Visibility.Collapsed;
    ...
    private void PowerOnPreset_SelectionChanged(object sender, SelectionChangedEventArgs e)
    {
        ...
        {
            "LastOnState" => HueCompanion.Core.Models.PowerOnPreset.LastOnState,
            "Safety" => HueCompanion.Core.Models.PowerOnPreset.Safety,
            "PowerFail" => HueCompanion.Core.Models.PowerOnPreset.PowerFail,
            "Custom" => HueCompanion.Core.Models.PowerOnPreset.Custom,
            _ => HueCompanion.Core.Models.PowerOnPreset.LastOnState
        };

        CustomPowerOnPanel.Visibility = preset == HueCompanion.Core.Models.PowerOnPreset.Custom
            ? Visibility.Visible
            : Visibility.Collapsed;
